...
<body class="bg-gray-150">
    ...
    <nav id="navbar" class="flex items-center justify-between px-10 lg:px-16 py-6 w-full bg-white">
        ...
        <div class="hidden md:flex lg:flex text-black md:text-[17px] lg:text-[18px] lg:gap-x-7 md:gap-1">
            ...
            <div class="hover:text-blue-500 duration-200 cursor-pointer p-1"><a href="login.html">Log In</a></div>
        </div>
    ...
    <div class="bg-white rounded-[50px] mx-5 p-6 sm:p-10 lg:flex items-start shadow-lg">
        <div class="lg:w-1/2 md:w-1/2 space-y-4">
            ...
            <button class="bg-blue-500 text-white hover:bg-black py-3 px-6 rounded-full font-bold">Book Appointment</button>
        </div>

        <div class="lg:w-1/2 md:w-1/2 lg:mt-0 ms-3 lg:text-left px-6">
    ...
    <footer class="sm:hidden bg-indigo-950 text-white rounded-[50px] mx-3 my-5 lg:p-10 p-5">
            ...
            <div>
                ...
                <ul class="text-gray-400 space-y-3">
                    <li class="flex items-center space-x-3">
                        <span class="bg-indigo-700 text-white py-3 px-4 rounded-[50%]"><i class="fa-solid fa-envelope text-white"></i></span>
                        <span>xxxxx@email.com</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        <span class="bg-indigo-700 text-white py-3 px-4 rounded-[50%]"><i class="fa-solid fa-phone text-white"></i></span>
                        <span>xxxxx-xxxxx</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        <span class="bg-indigo-700 text-white py-3 px-4 rounded-[50%]"><i class="fa-solid fa-map-marker-alt text-white"></i></span>
                        <span>ABC, XYZ</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
            <div class="flex space-x-5 mt-3 md:mt-0">
                <a href="#" class="bg-blue-700 py-3 px-4 rounded-[50%]"><i class="fa-brands fa-dribbble text-white"></i></a>
                <a href="#" class="bg-blue-700 py-3 px-4 rounded-[50%]"><i class="fa-brands fa-facebook-f text-white"></i></a>
